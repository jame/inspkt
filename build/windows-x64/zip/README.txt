      ...
      1) Please be running Windows/64 Bit 
      ...
      4) Run req.bat in the extract directory in a console. This installs 2 needed modules. You will get errors if you do not run this before the program.
      5) To see available commands use:
      inspkt -h

      6) To view a packet - the syntax is: inspkt -v c:\path\to\packet\packet.pkt
